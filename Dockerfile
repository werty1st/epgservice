...
# import image
# gunzip -c olympia2017.tar.gz | docker load


# console setup static port
# docker run -d --restart=on-failure -m 128M --link=ecmsdb --name=olympia2017 --env-file .npmrc olympia2017:1.0 npm run docker